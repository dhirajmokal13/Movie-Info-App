...
const MovieCard = (props) => {
    return (
        <SafeAreaView>
            <View className="relative text-gray-700 overflow-hidden bg-white shadow-md w-[340] rounded-xl my-2">
                <View className="relative m-5 max-h-[500] text-white shadow-lg bg-blue-gray-500 shadow-blue-gray-500/40">
