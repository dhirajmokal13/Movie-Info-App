    ...
    return (
        <SafeAreaView>
            ...
            <ScrollView horizontal={true}>
                {
                    isLoading ? (<View className="min-h-[120vw] flex-1 justify-center px-[40vw]"><ActivityIndicator size="large" color="#0000ff" /></View>) : movieResult?.map((item, index) => {
            ...
            <View className="px-5 flex flex-row items-center justify-center my-2">
                <TouchableOpacity className="mr-5" disabled={isLoading ? true : false} onPress={() => handlePagination("previous")}>
                ...
                <TouchableOpacity className="ml-5" disabled={isLoading ? true : false} onPress={() => handlePagination("next")}>
